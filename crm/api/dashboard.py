...
def download_lead_export(
	...
	rows = frappe.db.sql(  # nosemgrep
		...
		SELECT
			...
			l.custom_utm_content                AS utm_content,
			l.custom_utm_last_touch_source       AS utm_last_touch_source,
			l.custom_utm_last_touch_medium       AS utm_last_touch_medium,
			l.custom_utm_last_touch_campaign     AS utm_last_touch_campaign,
			l.custom_utm_last_touch_content      AS utm_last_touch_content,
			l.custom_utm_first_touch_source      AS utm_first_touch_source,
			l.custom_utm_first_touch_medium      AS utm_first_touch_medium,
			l.custom_utm_first_touch_campaign    AS utm_first_touch_campaign,
			l.custom_utm_first_touch_content     AS utm_first_touch_content,
			l.custom_gclid                       AS gclid,
			l.custom_fbclid                      AS fbclid,
			l.custom_wbraid                      AS wbraid,
			l.custom_gbraid                      AS gbraid,
