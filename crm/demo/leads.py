...
def create_demo_leads(demo_users):
	...
	leads_data = [
		# [0] Alice — will be converted to a deal
		{
			...
			"status": "C2",
			"source": "Lead Spotting",
			"custom_sub_source": "IndiFrame Projects",
		...
		# [3] David — will be converted to a deal
		{
			...
			"status": "C2",
			"source": "Referral",
			"custom_sub_source": "Architect / Interior Designer",
		...
		# [8] Iris — will be converted to a deal
		{
			...
			"status": "C2",
			"source": "Lead Spotting",
			"custom_sub_source": "IndiFrame Retail",
			"no_of_employees": "1-10",
	...
	for data, days in zip(leads_data, _LEAD_DAYS, strict=False):
		...
		lead = frappe.get_doc({"doctype": "CRM Lead", "custom_pincode": "000000", **data}).insert(
